...
def main():
    create_run_plot_model("mf6_dsp_f", L=10000, T=1000, dt=1000, z0=44, x_b=3500, h_b=1.9, dx=10, dz=0.1, h_modern=-1, H=36, D=5, T_modern=365*200, K_aquifer=3, dt_modern=365*200, alpha_L=5)
